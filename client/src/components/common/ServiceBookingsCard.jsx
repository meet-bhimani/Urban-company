              ...
              <form onSubmit={handleSubmit} onReset={handleReset} className="space-y-4 mt-4">
                ...
                <div>
                  <InputWithLabel
                    ...
                    onChange={handleChange}
                    onBlur={handleBlur}
                    className={touched.city && errors.city ? 'focus-within:border-danger focus-within:ring-danger' : ''}
                  />
                  {touched.city && errors.city && <p className="text-danger ml-1 text-xs xsm:text-sm">{errors.city}</p>}
                </div>
                <div>
                  <InputWithLabel
                    id="state"
                ...
                <div className="flex justify-end mt-2">
                  ...
                  <Button variant="danger" size="sm" rounded classNames="ml-2" onClick={handleCancelEditLocationClick}>
                    Cancel
                  </Button>
                </div>
              </form>
