  ...
  return (
    ...
    >
      <input
        ...
        value={value}
        onChange={onChange}
        className="w-[min(100%,600px)] mx-auto peer border-none bg-transparent placeholder-transparent autofill:bg-[transparent!important] focus:border-transparent focus:outline-none focus:ring-0 px-3 py-2"
